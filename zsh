...
export PATH=$PATH:$HOME/bin:/usr/local/bin:/usr/local/mysql/bin

# Path to your oh-my-zsh installation.
export ZSH="/Users/awillie/.oh-my-zsh"
...
alias mysql_start="sudo launchctl load -F /Library/LaunchDaemons/com.oracle.oss.mysql.mysqld.plist"
